...
from src.pipelines.question_answering import DEFAULT_MODEL, TASK, run_experiment
...
@patch("src.pipelines.question_answering.benchmark_pipeline")
@patch("src.pipelines.question_answering.hf_pipeline")
