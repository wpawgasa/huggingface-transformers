...
from src.pipeline_exploration.pipelines.translation import DEFAULT_MODEL, TASK, run_experiment
...
@patch("src.pipeline_exploration.pipelines.translation.benchmark_pipeline")
@patch("src.pipeline_exploration.pipelines.translation.hf_pipeline")
