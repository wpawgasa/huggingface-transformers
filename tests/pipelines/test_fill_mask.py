...
from src.pipelines.fill_mask import BERT_MODEL, DEFAULT_MODEL, TASK, run_experiment
...
@patch("src.pipelines.fill_mask.benchmark_pipeline")
@patch("src.pipelines.fill_mask.hf_pipeline")
